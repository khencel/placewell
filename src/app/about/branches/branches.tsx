...
const BRANCHES: Branch[] = [
  ...
  { id: 10, name: "DUMAGUETE (TRIPLEONE)",                region: "Visayas",  lat:  9.30875573049183, lng: 123.30882164223914, address: "2ND FLOOR QUIAMCO BUILDING NOBLEFRANCA STREET DUMAGUETE CITY, 6200 PHILIPPINES (IN FRONT OF HOLY CROSS HIGH SCHOOL)" },
  ...
  { id: 16, name: "ISABELA (TRIPLEONE)",         region: "Luzon", lat:  16.94182924823973, lng: 121.76893635167006, address: "Majestic Bldg, Nisperos St., Cabaruan, Cauayan City, Isabela (beside Bank of Commerce near Addessa)" },
  ...
  { id: 19,  name: "TACURONG (TRIPLEONE)",  region: "Mindanao",  lat: 6.683575079580638, lng: 124.66688197849201, address: "UNIT 2-C 2F, MERVIC COMMERCIAL BLDG., NATIONAL HIGHWAY, TACURONG CITY" },
